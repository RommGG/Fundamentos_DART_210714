...
class Team
{
    String name;
    String type;
    //El constructor de la clase siempre debe llavar el mismo nombre de la clase
    Team({required this.name, this.type="No definido."}); // Se utilizan llaves porque son datos que estaran por defecto
